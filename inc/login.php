...
add_filter('login_message', function () {
    $message = '<div id="poweredby" style="position:absolute;bottom:10px;left:0;width:100vw;text-align:center">Powered by <a href="https://portfolio.dalvae.cl/" target="_blank">Dalvae</a></div>';
    return $message;
});
